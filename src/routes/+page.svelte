...
<main>
  <header class="header" style="margin-inline: 0; width: 100%;">
    <div>
      ...
      <p
        class="h5"
        style="font-weight: 900; text-align: center; text-wrap: balance;"
      >
  ...
  >
    ...
    <p>
      <a
        class="button"
        href="https://raw.githubusercontent.com/stolinski/graffiti/refs/heads/main/src/lib/drop-in.css"
        >Just copy and paste from here</a
      >
    </p>
    <p>
      <a
