...
<main>
    ...
    <div class="stack">
      ...
      <div class="stack">
        <div class="box" style="line-height: var(--lh-tight)">
          ...
          This is tight line height, useful for headings and display text where you
          want compact vertical spacing. The quick brown fox jumps over the lazy
          dog.
        </div>
  ...
  <section class="demo-section stack">
    ...
    <p>
      Full-height sticky sidebar for app shells. Combine with <code
        >.split.vertical</code
      > for sidebar internal layout.
    </p>
  ...
  <section class="demo-section stack">
    ...
    <div class="layout-readable center stack" style="background: var(--fg-05)">
      <div class="box">
  ...
  <section class="demo-section stack">
    ...
    <div
      ...
      style="background: var(--fg-05); padding: 1rem; height: 200px;"
    >
  ...
  <section class="demo-section stack">
    ...
    <div class="stack">
      <h3>.avatar</h3>
      <p>
        Circular avatar for user images or initials. Supports multiple sizes and
        optional border.
      </p>
  ...
  <section class="demo-section stack">
    <h3>Breadcrumbs</h3>
    <p>
      Simple breadcrumb navigation with slash separators. Uses semantic HTML
  ...
  <section class="demo-section stack">
    ...
    <p>
      ...
      JavaScript required for open/close.
    </p>
  ...
  <section class="demo-section stack">
    ...
    <p>
      Vertical navigation for app sidebars with collapsible sections. Uses
      native details/summary for expand/collapse. Add <code>.active</code> class
  ...
  <section class="demo-section stack">
    <div class="stack">
      ...
      <p>
        ...
        with both image and initials avatars.
      </p>
  ...
  <section class="demo-section stack">
    ...
    <div class="stack">
      ...
      <p>Makes typography responsive to container width instead of viewport</p>
      <div class="layout-split">
        <div class="box">
    ...
    <div class="stack">
      <h3>.auto-color</h3>
      <p>
        Automatically sets text color (light or dark) based on background
        luminosity
      </p>
      <div class="flex" style="flex-wrap: wrap; gap: 1rem">
        <div
          class="auto-color"
          style="--bg-color: var(--blue-5); padding: var(--pad-m); border-radius: var(--br-m);"
        >
          Blue background
        </div>
        <div
          class="auto-color"
          style="--bg-color: var(--yellow-3); padding: var(--pad-m); border-radius: var(--br-m);"
        >
          Yellow background
        </div>
        <div
          class="auto-color"
          style="--bg-color: var(--red-7); padding: var(--pad-m); border-radius: var(--br-m);"
        >
          Dark red background
        </div>
        <div
          class="auto-color"
          style="--bg-color: var(--green-4); padding: var(--pad-m); border-radius: var(--br-m);"
        >
          Green background
        </div>
        <div
          class="auto-color"
          style="--bg-color: var(--purple-6); padding: var(--pad-m); border-radius: var(--br-m);"
        >
          Purple background
        </div>
      </div>
      <p class="fs-xs">
        Set <code>--bg-color</code> and the text color adjusts automatically
      </p>
    </div>
    ...
    <div class="stack">
      ...
      <div class="layout-card" style="--min-card-width: 200px">
        ...
        <div class="aspect-4-3 box" style="display: grid; place-items: center">
          .aspect-4-3<br />4:3
        </div>
        <div class="aspect-21-9 box" style="display: grid; place-items: center">
          .aspect-21-9<br />21:9
        </div>
      </div>
      <p class="fs-xs">
